...
export class FelConstants {
  ...
  static readonly UBOOT_MAX_SIZE_F: number = (FelConstants.SECTOR_SIZE * 0x5)
  static readonly BOOT_IMAGE_BASE_F: number = (FelConstants.SECTOR_SIZE * 0x30)
  static readonly BOOT_IMAGE_MAX_SIZE: number = (FelConstants.SECTOR_SIZE * 0x20)
